...
<div id="admin_header"><h3 style="padding: 14px 14px;">Secretary Log-in</h3></div>
<div id="admin_login">
...
<div id="admin_footer">	<input type="submit"
    ...
    $('#admin_submit').click(function(){
        ...
        $.ajax({
                    url:"<?php echo base_url()?>secretary-log_in_validate",
                    type: 'POST',
                    data: form_data,
                    success: function(msg){
                            ...
                            window.setTimeout(function(){
                                window.location = "<?php echo base_url()?>secret/candidates";
                            }, 2000);
...
<li><img src="<?php echo base_url()?>images/icon/reserve.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a id="reservation_link"href="<?php echo site_url('secret/reservation')?>">Reservations</a></li>
<li><img src="<?php echo base_url()?>images/icon/candidate.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a id="candidate_link"href="<?php echo site_url('secret/candidates')?>">Today</a></li>
<li><img src="<?php echo base_url()?>images/icon/presciption.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a id="prescription_link"href="<?php echo site_url('secret/prescription')?>">Prescription</a></li>
<li><img src="<?php echo base_url()?>images/icon/schedule.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a id="system_link"href="<?php echo site_url('secret/system_time')?>">Time Schedule</a></li> 
<li><img src="<?php echo base_url()?>images/icon/schedule.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a id="system_link"href="<?php echo site_url('secret/profile_edit')?>">Edit Profile</a></li>
<li><img src="<?php echo base_url()?>images/icon/logout.png" title="Patient" width="20" height="20" style="position:absolute; margin: 5px 40px;"/><a href="<?php echo base_url()?>secretary/log_out">Logout</a></li>
